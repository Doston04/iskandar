...
export const Footer = () => {
  ...
  return (
    <footer className="bg-mainGray sm:pt-[40px]">
      <div className="flex flex-col justify-center items-center max-w-[1200px] mx-auto px-6 relative">
        <div className="flex flex-col space-y-4 md:space-y-0 items-center justify-center my-4">
          <div className="md:absolute md:left-6 w-[200px] h-[50px]">
        ...
        <div className="flex items-center justify-center pb-4">
          <p className="text-[14px] sm:text-[16px] opacity-80"><span className="font-sans">&copy;</span> {currentYear}. Barcha huquqlar himoyalangan.</p>
        </div>
      </div>
    </footer>
  )  
