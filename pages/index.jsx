...
export default function Home() {
  ...
  return (
    <div>
      ...
      <div id='IndexUz' className='flex flex-col w-full min-h-screen text-textGray'>
        <main className='flex-auto bg-mainGray'>
          <section id='intro' className='h-screen w-full flex flex-col relative'>
            <div className='fixed top-0 inset-x-0 bg-mainGray z-40'><Header /></div>
          ...
          <section id='about'>
            <div className='bg-white flex justify-center items-center md:h-screen py-[60px] md:py-0'>
              <div className='max-w-[1200px] mx-auto px-4 w-full h-full flex md:grid md:grid-cols-2 items-center gap-20'>
                <div className='aboutGrid h-full'>
                  <div className='aboutGrid__Top'>
                    <div className='border border-green-500 w-full h-[70%] topDiv'></div>
                    <div className='w-[120px] h-[120px] bg-teal rounded-full'></div>
                  </div>
                  <div className=''>
                    <div className='border border-green-500 h-[70%] bottomDiv'></div>
                  </div>
                </div>
                <div className='flex flex-col items-center md:items-start justify-center space-y-[16px] md:space-y-[24px]'>
                  ...
                  <p className='uppercase font-bold text-[22px] leading-[30px] md:text-[32px] md:leading-[38px] lg:text-[44px] lg:leading-[48px] text-center md:text-left'>Bemorning salomatligi bizning eng yuqori qadriyatimizdir</p>
                  <p className='opacity-60 text-center md:text-left'>Eng yangi uskunalar, yuqori aniqlikdagi texnologiyalar va jahon tibbiyotining eng yaxshi yutuqlari bemorlar uchun mutlaqo yangi, misli ko&apos;rilmagan darajada og&apos;riqsiz davolashga imkon beradi.</p>
                  <div>
                    <button className='buttonBlue'>Ko&apos;proq ma&apos;lumot</button>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section id='contacts'>
            <div className='min-h-screen md:h-screen bg-white flex flex-col space-y-8 md:space-y-0 md:flex-row justify-center items-center relative overflow-hidden'>
